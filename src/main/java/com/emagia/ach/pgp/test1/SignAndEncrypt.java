/*
package com.emagia.ach.pgp.test1;
*
 * 
	...
	public static void main(String[] args) {
		...
		try {
			pubKey = readPublicKey(loader
					.getResourceAsStream("src/main/resources/Sign/staplesKey.asc"));
		...
		try {
			pgpSec = readSecretKey(loader
					.getResourceAsStream("src/main/resources/Sign/emaigakeys.asc"));
		} catch (IOException | PGPException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
*
	...
	public static String encryptByteArray(byte[] clearData,
		...
		PGPEncryptedDataGenerator cPk = new PGPEncryptedDataGenerator(
				PGPEncryptedData.AES_256, withIntegrityCheck, new SecureRandom(),
				"BC");
		//encKey
		PGPKeyEncryptionMethodGenerator encKeyMethodGen = new ;
		cPk.addMethod(encKeyMethodGen);
